...
class c_display {
public:
	c_display(void* phy_fb, unsigned int width, unsigned int height, unsigned int color_bits, unsigned int slides_cnt);
	...
	unsigned int get_color_bits() { return m_color_bits; }
...
private:
	...
	unsigned int	m_color_bits;	//16,24,32
	void*			m_phy_fb;

...
void load_ui_single(void* phy_fb, int color_bytes)
{
	c_display* display = new c_display(phy_fb, SCREEN_WIDTH, SCREEN_HEIGHT, color_bytes, 4);
...
void load_ui_multi(void* phy_fb, int color_bytes)
{
	c_display* display = new c_display(phy_fb, SCREEN_WIDTH, SCREEN_HEIGHT, color_bytes, 4);
	c_surface* surface = display->create_surface(&s_root, Z_ORDER_LEVEL_0);
	surface->set_active(true);
...
void load_mini_ui_single(void* phy_fb, int color_bytes)
{
	c_display* display = new c_display(phy_fb, MINI_SCREEN_WIDTH, MINI_SCREEN_HEIGHT, color_bytes, 2);
...
void load_mini_ui_multi(void* phy_fb, int color_bytes)
{
	c_display* display = new c_display(phy_fb, MINI_SCREEN_WIDTH, MINI_SCREEN_HEIGHT, color_bytes, 2);
	c_surface* surface = display->create_surface(&s_mini_root, Z_ORDER_LEVEL_0);
	surface->set_active(true);
